...
const specials = [
{
  ...
  description: 'Any espresso drink + egg drop sandwich combo at a special bundled price. Start your week right.',
  price: '₱149',
  originalPrice: '₱164',
...
},
{
  ...
  description: 'Korean ramyeon with extra egg topping + any cold drink. Perfect for the end-of-week wind-down.',
  price: '₱129',
  originalPrice: '₱198',
...
},
{
  ...
  description: 'Large bingsu shaved ice dessert paired with iced matcha or strawberry milk. Weekends only!',
  price: '₱179',
  originalPrice: '₱215',
...
function SketchFrame({ color = '#C8A96E' }: {color?: string;}) {
  return (
    <svg
      ...
      <path d="M8 8 Q6 6 10 6 L290 6 Q294 6 292 8 L292 392 Q294 394 290 394 L10 394 Q6 394 8 392 Z"
      stroke={color} strokeWidth="1.2" strokeDasharray="4 3" opacity="0.3" fill="none" />
    </svg>);
...
export default function DailySpecialsSection() {
  ...
  return (
    <section id="specials" ref={ref} className="py-20 sm:py-28 px-5 sm:px-8 bg-parchment relative overflow-hidden">
      {/* Background doodle pattern */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.03]"
      style={{
        backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M20 0 L20 40 M0 20 L40 20' stroke='%232C1A0E' stroke-width='0.5'/%3E%3C/svg%3E\")",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`text-center mb-14 reveal ${visible ? '' : 'hidden-init'}`}>
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-muted">Daily Specials</span>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-gold">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
            </svg>
          </div>
          ...
          <div
            ...
            style={{ transitionDelay: `${i * 120}ms` }}>
              ...
              <div className="h-52 overflow-hidden relative">
                ...
                {/* Day badge */}
                <div className={`absolute top-3 left-3 ${special.tagColor} text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-sketch shadow-sketch`}>
                  {special.day}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-baseline gap-2">
                    <span className="font-display text-2xl font-bold text-espresso">{special.price}</span>
                    <span className="text-muted/50 text-sm line-through">{special.originalPrice}</span>
                  </div>
